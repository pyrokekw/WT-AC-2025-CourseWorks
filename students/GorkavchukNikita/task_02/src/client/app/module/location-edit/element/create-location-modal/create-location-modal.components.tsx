...
import { useCreateLocationServices } from './create-location-modal.services'
import { createLocationFormFields } from './create-location-modal.constants'
...
export const CreateLocationModal = ({ open, onClose, onSuccess }: IProps) => {
    const thisService = useCreateLocationServices({ onSuccess, open })

    const handleClose = () => {
        onClose?.()
    }

    const isSubmitDisabled = thisService.citiesLoading || thisService.cityOptions.length === 0
                    ...
                    >
                        <Field className={clsx('form-field', thisService.errors.type && 'error')}>
                            ...
                            <select
                                ...
                                {...thisService.register(
                                    createLocationFormFields.type.fieldName,
                                    createLocationFormFields.type.validationOptions
                                )}
                            >
                        ...
                        <Field className={clsx('form-field', thisService.errors.label && 'error')}>
                            ...
                            <Input
                                className="form-field-input"
                                {...thisService.register(
                                    createLocationFormFields.label.fieldName,
                                    createLocationFormFields.label.validationOptions
                                )}
                            />
                            <Description className="form-field-error">
                        ...
                        <Field
                            className={clsx(
                                'form-field',
                                thisService.errors.locationCode && 'error'
                            )}
                        >
                            ...
                            <Input
                                ...
                                {...thisService.register(
                                    createLocationFormFields.locationCode.fieldName,
                                    createLocationFormFields.locationCode.validationOptions
                                )}
                            />
                            <Description className="form-field-error">
                                {thisService.errors.locationCode &&
                                    thisService.errors.locationCode.message}
                            </Description>
                        </Field>
                        ...
                        <Field className={clsx('form-field', thisService.errors.cityId && 'error')}>
                            ...
                            <select
                                className="form-field-input"
                                {...thisService.register(
                                    createLocationFormFields.cityId.fieldName,
                                    createLocationFormFields.cityId.validationOptions
                                )}
                            >
                                <option value="" disabled>
                                    Select city
                        ...
                        <Field
                            className={clsx(
                                'form-field',
                                thisService.errors.postalCode && 'error'
                            )}
                        >
                            ...
                            <Input
                                className="form-field-input"
                                {...thisService.register(
                                    createLocationFormFields.postalCode.fieldName,
                                    createLocationFormFields.postalCode.validationOptions
                                )}
                            />
                            <Description className="form-field-error">
                                {thisService.errors.postalCode &&
                                    thisService.errors.postalCode.message}
                            </Description>
                        </Field>
                        ...
                        <Field className={clsx('form-field', thisService.errors.street && 'error')}>
                            ...
                            <Input
                                className="form-field-input"
                                {...thisService.register(
                                    createLocationFormFields.street.fieldName,
                                    createLocationFormFields.street.validationOptions
                                )}
                            />
                            <Description className="form-field-error">
