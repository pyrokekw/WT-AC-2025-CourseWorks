...
import { useDeleteOrderServices } from './delete-order-modal.services'
...
export const DeleteOrderModal = ({ open, onClose, selectedOrder, onSuccess }: IProps) => {
    const thisService = useDeleteOrderServices({ selectedOrder, onSuccess })
