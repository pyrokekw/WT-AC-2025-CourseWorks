...
import { useDeleteCountryServices } from './delete-country-modal.services'
...
export const DeleteCountryModal = ({ open, onClose, selectedCountry, onSuccess }: IProps) => {
    const thisService = useDeleteCountryServices({ selectedCountry, onSuccess })
