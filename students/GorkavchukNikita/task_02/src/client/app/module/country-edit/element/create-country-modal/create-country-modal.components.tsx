...
import { useCreateCountryServices } from './create-country-modal.services'
import { createCountryFormFields } from './create-country-modal.constants'
...
export const CreateCountryModal = ({ open, onClose, onSuccess }: IProps) => {
    const thisService = useCreateCountryServices({ onSuccess })
                    ...
                    >
                        <Field className={clsx('form-field', thisService.errors.name && 'error')}>
                            ...
                            <Input
                                ...
                                {...thisService.register(
                                    createCountryFormFields.name.fieldName,
                                    createCountryFormFields.name.validationOptions
                                )}
                            />
                        ...
                        >
                            ...
                            <Input
                                ...
                                {...thisService.register(
                                    createCountryFormFields.countryCode.fieldName,
                                    createCountryFormFields.countryCode.validationOptions
                                )}
                            />
                            <Description className="form-field-error">
