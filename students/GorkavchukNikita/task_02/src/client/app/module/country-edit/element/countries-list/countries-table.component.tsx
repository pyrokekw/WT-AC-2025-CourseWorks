...
import { useCountriesTable } from './countries-table.services'

interface ICountriesTableProps {
    onRowClick?: (country: ICountry) => void
    onDeleteClick?: (country: ICountry) => void
    refreshToken: number
}

export const CountriesTableComponent = ({
    onRowClick,
    onDeleteClick,
    refreshToken,
}: ICountriesTableProps) => {
    const { countries, page, totalPages, isLoading, error, goPrev, goNext, goToPage } =
        useCountriesTable({ refreshToken })

    if (isLoading) {
        return <div className="py-8 text-center text-gray-500">Countries Loading...</div>
    }
                ...
                <table className="min-w-full text-left text-sm">
                    <thead className="bg-gray-50">
                        <tr>
                            ...
                            <th className="px-4 py-3 font-medium text-gray-500">Country code</th>
